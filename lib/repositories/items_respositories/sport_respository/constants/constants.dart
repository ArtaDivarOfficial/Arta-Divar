class SportConstants {
  // API Constants
  static const String apiAddSport = '/add_sport';
  static const String apiShowSportDetails = '/show_sport_details';
  static const String apiEditSport = '/edit_sport';
  static const String apiDeleteSport = '/delete_sport';
  static const String apiShowAllSport = '/show_all_sport';
  static const String apiSearchSport = '/search_sport';
  static const String apiSportImages = '/sport_images';
  static const String apiSoldSport = '/sold_sport';
  // Model Constants
