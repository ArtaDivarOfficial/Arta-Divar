class NecessityConstants {
  // API Constants
  static const String apiAddNecessity = '/add_necessity';
  static const String apiShowNecessityDetails = '/show_necessity_details';
  static const String apiEditNecessity = '/edit_necessity';
  static const String apiDeleteNecessity = '/delete_necessity';
  static const String apiShowAllNecessities = '/show_all_necessities';
  static const String apiSearchNecessity = '/search_necessity';
  static const String apiNecessitiesImages = '/necessities_images';
  static const String apiSoldNecessity = '/sold_necessity';
  // Model Constants
