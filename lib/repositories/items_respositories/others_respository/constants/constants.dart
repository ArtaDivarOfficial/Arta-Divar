class OthersConstants {
  // API Constants
  static const String apiAddOthers = '/add_others';
  static const String apiShowOthersDetails = '/show_others_details';
  static const String apiEditOthers = '/edit_others';
  static const String apiDeleteOthers = '/delete_others';
  static const String apiShowAllOthers = '/show_all_others';
  static const String apiSearchOthers = '/search_others';
  static const String apiOthersImages = '/others_images';
  static const String apiSoldOthers = '/sold_others';
  // Model Constants
