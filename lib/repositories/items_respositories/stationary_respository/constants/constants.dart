class StationaryConstants {
  // API Constants
  static const String apiAddStationary = '/add_stationary';
  static const String apiShowStationaryDetails = '/show_stationary_details';
  static const String apiEditStationary = '/edit_stationary';
  static const String apiDeleteStationary = '/delete_stationary';
  static const String apiShowAllStationary = '/show_all_stationary';
  static const String apiSearchStationary = '/search_stationary';
  static const String apiStationaryImages = '/stationary_images';
  static const String apiSoldStationary = '/sold_stationary';
  // Model Constants
