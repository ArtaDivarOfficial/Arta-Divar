class FoodstuffsConstants {
  // API Constants
  static const String apiAddFoodstuffs = '/add_foodstuffs';
  static const String apiShowFoodstuffsDetails = '/show_foodstuffs_details';
  static const String apiEditFoodstuffs = '/edit_foodstuffs';
  static const String apiDeleteFoodstuffs = '/delete_foodstuffs';
  static const String apiShowAllFoodstuffs = '/show_all_foodstuffss';
  static const String apiSearchFoodstuffs = '/search_foodstuffs';
  static const String apiFoodstuffsImages = '/foodstuffss_images';
  static const String apiSoldFoodstuffs = '/sold_foodstuffs';
  // Model Constants
